	...
	$this->add_control(
	 ...
	 $this->add_responsive_control(
			'colnum',[
				        ...
				        'default' => 3,
				        'selectors' => [
					    '{{WRAPPER}} .mainrepeater' => 'grid-template-columns: repeat({{VALUE}},1fr);',
    ...
    $orderfield = [
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', 'em', '%' ],
				'selectors' => [
					'{{WRAPPER}} .repeateritem' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
